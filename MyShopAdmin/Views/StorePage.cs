            ...
            Content = new TableView
            {
                ...
                Root = new TableRoot {
                    new TableSection ("Information") {
                        (name = new EntryCell {Label = "Name", Text = Store.Name, Placeholder = "type here..."}),
                        (locationHint = new EntryCell {Label = "Location Hint", Text = Store.LocationHint, Placeholder = "type here..."}),
                        (phoneNumber = new EntryCell {Label = "Phone Number", Text = Store.PhoneNumber, Placeholder ="555-555-5555"}),
                        (locationCode = new EntryCell {Label = "Location Code", Text = Store.LocationCode, Placeholder = "type here..."}),
                    ...
                    new TableSection ("Address") {
                        (streetAddress = new EntryCell {Label = "Street Address", Text = Store.StreetAddress, Placeholder = "type here..." }),
                        (city = new EntryCell {Label = "City", Text = Store.City, Placeholder = "type here..." }),
                        (state = new EntryCell {Label = "State", Text = Store.State , Placeholder = "type here..."}),
                        (zipCode = new EntryCell {Label = "Zipcode", Text = Store.ZipCode , Placeholder = "type here..."}),
                        (country = new EntryCell{Label="Country", Text = Store.Country, Placeholder = "type here..."}),
